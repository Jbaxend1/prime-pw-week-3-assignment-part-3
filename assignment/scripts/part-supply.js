...
console.log('6. Showing supplyChanges...', values);
...
console.log('7. Showing supplyChanges with "for of" loop', values );
...
console.log('9. Filling boxes with a "while" loop', box);